...
const Detail = () => {
   ...
   useEffect(() => {
     fetch(`https://warm-shelf-43613.herokuapp.com/services/${serviceId}`)
     .then(res=>res.json())
   ...
   const onSubmit = data =>{
      data.email=email;
     fetch('https://warm-shelf-43613.herokuapp.com/confirmOrder',{
        method:'POST',
      ...
      <div className=' container-fluid detail'>
         <div className='row'>
            <div className='col-lg-6 col-md-6 col-12'>
               <h3 className='pb-3'><span className='text-success fs-1'>{service?.name}</span></h3>
