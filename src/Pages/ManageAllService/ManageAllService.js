...
const ManageAllService = () => {
    ...
    useEffect(()=>{
        fetch('https://warm-shelf-43613.herokuapp.com/allOrders')
        .then(res=>res.json())
    ...
    const handleDelete=(id)=>{
        ...
        if(proceed){
            fetch(`https://warm-shelf-43613.herokuapp.com/deletelOrder/${id}`,{
                method:'DELETE',
             })
             .then(res=>res.json())
             .then(data=>{
    ...
    return (
        <div className='all-orders'>
             ...
             <h3 className='pb-5 pt-1 text-success fs-3'>You can delete the Booking</h3>
